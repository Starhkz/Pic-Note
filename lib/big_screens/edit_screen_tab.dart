...
class EditScreenTab extends StatefulWidget {
  final int id;
  final bool isNew;
  ...
  @override
  _EditScreenTabState createState() => _EditScreenTabState();
}

class _EditScreenTabState extends State<EditScreenTab> {
  int id = 0;
    ...
    return WillPopScope(
      ...
      onWillPop: () async {
        ...
        if (canSaveNote()) {
          ...
          exitPrompt(context, save, controller: widget.controller, isTab: true);
        } else {
            ...
            onPressed: () {
              ...
              if (canSaveNote()) {
                ...
                exitPrompt(context, save,
                    controller: widget.controller, isTab: true);
              } else {
                Utils().logger(cEditNote, cCantSave);
                navHome();
              }
